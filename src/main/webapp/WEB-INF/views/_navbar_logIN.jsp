...
<%--                        <a href="${pageContext.request.contextPath}/login" type="button" class="btn btn-outline-success">Вход</a>--%>
                        <a href="${pageContext.request.contextPath}/TacoBoom?rule=loginPage" type="button" class="btn btn-outline-success">Вход</a>
                    </div>
...
<%--                        <a href="${pageContext.request.contextPath}/registration" type="button" class="btn btn-outline-primary">Регистрация</a>--%>
                        <a href="${pageContext.request.contextPath}/TacoBoom?rule=registrationPage" type="button" class="btn btn-outline-primary">Регистрация</a>
                    </div>
                </div>
            </form>
        </div>
